declare const Form: import('@cc-ui-plus/utils').SFCWithPlugin<
  ...
  >
>
declare const FormItem: import('@cc-ui-plus/utils').SFCWithPlugin<
  import('vue').DefineComponent<
    {
      label: {
...
declare const _default: {
  Form: import('@cc-ui-plus/utils').SFCWithPlugin<
    import('vue').DefineComponent<
      {
        model: {
          type: ObjectConstructor
    ...
    >
  >
  FormItem: import('@cc-ui-plus/utils').SFCWithPlugin<
    import('vue').DefineComponent<
      {
        label: {
          type: StringConstructor
